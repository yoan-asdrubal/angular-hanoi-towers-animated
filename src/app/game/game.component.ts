...
export class GameComponent implements OnInit {
  ...
  discoFormControl = new FormControl(4, Validators.required);
  tiempoAnimacionFormControl = new FormControl(600, Validators.required);
  ...
  ngOnInit() {
    ...
    this.discoFormControl.valueChanges
      .pipe(
        filter(value => value > 0),
        distinctUntilChanged(),
        tap(value => this.crear())
      )
      .subscribe();
  }
